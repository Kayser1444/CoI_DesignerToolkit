...
* ~~Export single BP details to clipboard as Markdown~~
    - "Copy as Markdown" button injected into the blueprint Detail panel. Copies paste-ready Markdown: heading, description, Components table, Construction table, and Operational table. Suitable for Hub posts.
